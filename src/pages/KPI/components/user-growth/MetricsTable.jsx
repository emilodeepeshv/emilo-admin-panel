...
const MetricsTable = ({ dateFilter, userTypeFilter }) => {
  ...
  const tableData = [
    { 
      ...
      today: getFilteredValues(27430, 1).toLocaleString(), 
      yesterday: getFilteredValues(26180, 1).toLocaleString(), 
      change: '+4.8%', 
      avg30d: getFilteredValues(25890, 1).toLocaleString(), 
      trend: 'up' 
    },
    { 
      metric: 'New Signups', 
      today: getFilteredValues(164, 1), 
      yesterday: getFilteredValues(133, 1), 
      change: '+23.1%', 
      avg30d: getFilteredValues(147, 1), 
      trend: 'up' 
    },
    { 
      metric: 'Churn Rate', 
